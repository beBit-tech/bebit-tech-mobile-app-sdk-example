...
const HomeScreen = ({ navigation }: any) => {
  ...
  useEffect(() => {
    ...
    // Purpose: provide the user's uid to the sdk, so that the sdk can use it when sending records.
    // https://github.com/beBit-tech/bebit-tech-react-native-app-sdk/wiki/Usage
    OmniSegment.setUid("omnisegment20240101")
    const products: [OSGProduct] = CoffeeList.map((i: any) => ({id: i.id, name: i.name}))
